    ...
    <div id="friends-list">
        ...
        <div id="selector-container">
            <div class="selector-row">
                ...
                <div id="selector-btn" @click="toggleSelector" :class="{ 'active': isSelectorShow }"
                    aria-label="筛选控制按钮">
        ...
        <div id="blog-container">
            ...
            <template v-else>
                <FriendCard v-for="friend in filteredFriends" :friend="friend" :key="friend.name"
                    :is-template="friend.name === '你的姓名'" @template-click="copyTemplateToClipboard"
